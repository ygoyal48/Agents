...
>
> **Built from six sources:** (1) the *Peaceful Investing* method book (framework — §1–§16); (2) the *Case Studies* ebook
...
> and (6) the *Company Analyses Vol. 4* ebook (10 deep-dives — **§21**: **the business-return / benchmarking-formula book** — *does the asset earn more
...
> §17–§21 are my fast pattern-match reference: when analyzing any company, find the closest case and copy its reasoning.
> Refinements discovered in the case books are folded into §1–§16 and tagged **[CS]** (Case Studies), **[V1]** (Vol 1), **[V2]** (Vol 2), **[V3]** (Vol 3), or **[V4]** (Vol 4).
>
