...
>
> **Built from seven sources:** (1) the *Peaceful Investing* method book (framework — §1–§16); (2) the *Case Studies* ebook
...
> and (7) the *Company Analyses Vol. 5* ebook (10 deep-dives — **§22**: **the cyclical-&-value-trap book** — *never value a cyclical or a weak business on
...
> §17–§22 are my fast pattern-match reference: when analyzing any company, find the closest case and copy its reasoning.
> Refinements discovered in the case books are folded into §1–§16 and tagged **[CS]** (Case Studies), **[V1]** (Vol 1), **[V2]** (Vol 2), **[V3]** (Vol 3), **[V4]** (Vol 4), or **[V5]** (Vol 5).
>
